...
{
    public class ConfirmEmailService : ReturnBase, IConfirmEmailService
    {
        ...
        public ConfirmEmailService(UserManager<User> userManager, IHttpContextAccessor httpContextAccessor,
        ...
        public async Task<ReturnBase<bool>> SendConfirmationEmailAsync(User user)
        {
            try
            {
                if (user is not null)

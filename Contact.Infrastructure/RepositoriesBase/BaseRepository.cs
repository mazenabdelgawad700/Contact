using Contact.Domain.Interfaces.RepositoryBase;
using Contact.Infrastructure.Context;
using Contact.Shared.Bases;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Storage;

namespace Contact.Infrastructure.RepositoriesBase
{
    public class BaseRepository<T> : ReturnBase, IBaseRepository<T> where T : class
    {
